<script>
	window.appointment = JSON.parse('<?= json_encode($data['appointment']) ?>');

</script>
<div class="wrapper" style="margin-top:60px">
	<div class="container">
		<h2 class="page-header">Edit Appointment</h2>
		<form name="book-appointment" action="" method="POST" class="form-horizontal" role="form">
			...
			<div class="form-group">
				...
				<div class="col-md-10">
					<input name="appointment_date" type="date" value="<?= $data['appointment']->appointment_date ?>" class="form-control">
				</div>
			</div>
			<div role="tabpanel">
				<!-- Nav tabs -->
				...
				<div class="tab-content">
					<div role="tabpanel" class="tab-pane active" id="picktime">
						<div class="form-group">
							...
							<div class="col-md-5">
								<input name="appointment_time" type="time" value="<?= $data['appointment']->appointment_time ?>" class="form-control">
							</div>
							<div class="col-md-5">
								<input name="appointment_hour" type="number" value="<?= $data['appointment']->appointment_hour ?>" min="1" max="4" class="form-control">
							</div>
						</div>
					</div>
			...
			<div class="form-group">
				...
				<div class="col-md-10">
					<textarea name="message" rows="5" class="form-control" placeholder="Write some suggestion or Describe your symptoms if any"><?= $data['appointment']->message ?></textarea>
				</div>
			</div>

			<div class="form-group">
				<div class="col-sm-10 col-sm-offset-2">
					<button name="submit" type="submit" class="btn btn-lg btn-primary">Update</button>
					 <a href="<?= ASSET_ROOT ?>/patient/appointment" class="btn btn-lg btn-default">Cancel</a>
				</div>
			</div>
		</form>
	</div>

<div class="wrapper" style="margin-top:60px">
    <div class="container">
        <form name="edit-profile" action="<?= ASSET_ROOT ?>/patient/editprofile" class="form-horizontal" method="POST" role="form">
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <input name="email" type="text" class="form-control" placeholder="Your Email" value="<?= $_SESSION['user']->email ?>" required>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <div class="col-md-4 col-md-offset-2">
                    ...
                    <a href="<?= ASSET_ROOT ?>/patient/profile" class="btn btn-lg btn-default">cancel</a>
                </div>
            </div>
        </form>
    </div>
